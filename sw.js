const CACHE="brk-v13",ASSETS=["/logo.svg?v=11","/logo-white.svg?v=11","/favicon.svg","/favicon.ico","/favicon-96x96.png","/apple-touch-icon.png","/texture.png","/theme.css?v=1","/core.js?v=1"];
